...
# If the gallery is already registered, should fail saying repository already exists
Register-PSRepository -PSGallery

# Should register the repository "TestRepo"
Register-PSResourceRepository "TestRepo" -url "http://www.testrepo.com"

# Should register the repository "TestRepo"
Register-PSResourceRepository -name "TestRepo" -url "http://www.testrepo.com"

# Should register the repository "TestRepo" as trusted, priority should be set to 0
Register-PSResourceRepository -name "TestRepo" -url "http://www.testrepo.com" -Trusted
...
################################
### Get-PSResourceRepository ###  All passing
################################
...
Set-PSResourceRepository "TestRepo" -url "www.testrepo.com"
...
#######################################
### Unregister-PSResourceRepository ###  All passing
#######################################
